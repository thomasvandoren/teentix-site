...
class Extension_builder_favorites extends Addon_builder_favorites {
	...
	function Extension_builder_favorites($name='')
	{
		parent::Addon_builder_favorites($name);
	...
	/* END Extension_builder_favorites() */
