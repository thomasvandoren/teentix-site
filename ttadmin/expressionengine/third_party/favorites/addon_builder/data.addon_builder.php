...
class Addon_builder_data_favorites {
	...
	function Addon_builder_data_favorites(&$parent_aob_instance = FALSE)
    {	
    ...
    /* END Addon_builder_data_favorites() */
	...
	{			
		...
		if ( ! in_array($method, $this->aob_non_static_friendly) AND 
			 is_callable(array('Addon_builder_favorites', $method))) 
		{						
			return call_user_func_array(array('Addon_builder_favorites', $method), $args);
		}
	}
 	//end __call
