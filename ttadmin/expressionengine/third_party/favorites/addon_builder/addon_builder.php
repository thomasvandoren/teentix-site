...
class Addon_builder_favorites {
	...
	public function Addon_builder_favorites ($name='')
	{
		//path to this folder
		...
		if (APP_VER < 2.0)
		{
			...
			if (($parent_class == 'Extension_builder_favorites' OR 
				 $super_parent_class == 'Extension_builder_favorites') AND 
		...
		{			
			...
			{
				if ( ! class_exists('Addon_builder_data_favorites'))
				{
					require_once $this->aob_path . '/data.addon_builder.php';
				}
				
				$this->data = new Addon_builder_data_favorites($this);
			}
		}
		...
		//--------------------------------------------
		// documentDOM_favorites instantiated, might move this.
		//--------------------------------------------

		if (REQ == 'CP' AND file_exists($this->aob_path . '/document_dom.php'))
		{
			if ( ! class_exists('documentDOM_favorites'))
			{
				require_once $this->aob_path . '/document_dom.php';
			}
		
			$this->document = new documentDOM_favorites();
		}
