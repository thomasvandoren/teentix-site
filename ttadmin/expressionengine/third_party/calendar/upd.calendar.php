...
class Calendar_upd extends Module_builder_calendar
{
	...
	public function install()
	{
		...
		if ( ! isset($calendars_fields[CALENDAR_CALENDARS_FIELD_PREFIX . 'summary']))
		{
			$fields[] = array(
				...
				'field_related_to'		=>	(APP_VER < 2.0) ? 'blog' : 'channel',
				'field_related_id'		=>	'0',
	...
	public function update()
	{
		...
		if (APP_VER < 2.0 AND
			! $this->extensions_enabled() AND
			! $this->extensions_allowed()
		)
		{
			return ee()->output->show_user_error(
				'general',
				lang('cannot_update_extensions_disabled')
			);
		}
