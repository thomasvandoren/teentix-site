...
class Addon_builder_calendar {
	...
	public function Addon_builder_calendar ($name='')
	{
		//path to this folder
		...
		if (APP_VER < 2.0)
		{
			...
			if (($parent_class == 'Extension_builder_calendar' OR 
				 $super_parent_class == 'Extension_builder_calendar') AND 
		...
		//--------------------------------------------
		// documentDOM_calendar instantiated, might move this.
		//--------------------------------------------

		if (REQ == 'CP' AND file_exists($this->aob_path . '/document_dom.php'))
		{
			if ( ! class_exists('documentDOM_calendar'))
			{
				require_once $this->aob_path . '/document_dom.php';
			}
		
			$this->document = new documentDOM_calendar();
		}
