...
class documentDOM_fbc {
    ...
    {
    	$obj = new createElement_fbc($name, $attributes);
    	return $obj;
	}
	/* END */
...
class createElement_fbc extends documentDOM_fbc
{
	var $element	= '';
	...
	function createElement_fbc($name, $attributes = array())
	{
		if ($name == '') return;
