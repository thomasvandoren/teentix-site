...
if (APP_VER < 2.0)
{
	eval('class Addon_builder_parser_base_fbc extends Template { }');
}
else
{
	eval('class Addon_builder_parser_base_fbc extends EE_Template { }');
}

class Addon_builder_parser_fbc extends Addon_builder_parser_base_fbc
{
	private $old_get = '';
