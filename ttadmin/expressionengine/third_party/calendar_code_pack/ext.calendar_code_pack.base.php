...
class Calendar_code_pack_extension_base extends Extension_builder_calendar_code_pack
{	
	var $name			= '';
	var $version		= '';
	var $description	= '';
	...
	function Calendar_code_pack_extension_base( $settings = array() )
    {    	
    	parent::Extension_builder_calendar_code_pack('calendar_code_pack');
        ...
        {
        	ee()->lang->loadfile('calendar_code_pack');
        
        	$this->name			= ee()->lang->line('calendar_code_pack_name');
        	$this->description	= ee()->lang->line('calendar_code_pack_description');
        }
        
		$this->version		= CALENDAR_CODE_PACK_VERSION;
		$this->docs_url		= CALENDAR_CODE_PACK_DOCS_URL;
	 ...
	 * Code pack install
	 *
	 * This method runs during the installation of a code pack in the Calendar module CP. It adds some members, weblog data and some calendar module data.
	 *
	 * @access	public
	 * @param	message
	 * @return	string
    ...
    /*	End calendar code pack install */
    ...
    function code_pack_list( $code_packs )
    {
    	...
    	$this_code_pack['calendar_code_pack']	= array(
    		'code_pack_name'			=> $this->lower_name,
    		'code_pack_label'			=> ee()->lang->line( 'calendar_code_pack_name' ),
    		'code_pack_description'		=> ee()->lang->line( 'calendar_code_pack_description' ),
    		'code_pack_theme_folder'	=> 'calendar',
    	);
