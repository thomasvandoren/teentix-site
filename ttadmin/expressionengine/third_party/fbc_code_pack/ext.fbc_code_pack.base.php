 ...
 * @filesource 	./system/extensions/fbc_code_pack/ext.fbc_code_pack.base.php
 */
 
require_once 'addon_builder/extension_builder.php';
 
class Fbc_code_pack_extension_base extends Extension_builder_fbc_code_pack
{	
	var $name			= '';
	var $version		= '';
	var $description	= '';
	...
	function Fbc_code_pack_extension_base( $settings = array() )
    {    	
    	parent::Extension_builder_fbc_code_pack('fbc_code_pack');
        ...
        {
        	ee()->lang->loadfile('fbc_code_pack');
        
        	$this->name			= ee()->lang->line('fbc_code_pack_name');
        	$this->description	= ee()->lang->line('fbc_code_pack_description');
        }
        
		$this->version		= FBC_CODE_PACK_VERSION;
		$this->docs_url		= FBC_CODE_PACK_DOCS_URL;
	 ...
	 * Code pack install
	 *
	 * This method runs during the installation of a code pack in the FBC module CP. It adds some members, weblog data and some FBC module data.
	 *
	 * @access	public
	 * @param	message
	 * @return	string
    ...
    function code_pack_list( $code_packs )
    {
    	...
    	$this_code_pack['fbc_code_pack']	= array(
    		'code_pack_name'			=> $this->lower_name,
    		'code_pack_label'			=> ee()->lang->line( 'fbc_code_pack_name' ),
    		'code_pack_description'		=> ee()->lang->line( 'fbc_code_pack_description' ),
    		'code_pack_theme_folder'	=> 'fbc',
    	);
