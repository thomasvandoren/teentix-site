...
if (APP_VER < 2.0)
{
	eval('class Addon_builder_parser_base_user extends Template { }');
}
else
{
	eval('class Addon_builder_parser_base_user extends EE_Template { }');
}

class Addon_builder_parser_user extends Addon_builder_parser_base_user
{
	private $old_get = '';
