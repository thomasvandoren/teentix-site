...
class documentDOM_rating {
    ...
    {
    	$obj = new createElement_rating($name, $attributes);
    	return $obj;
	}
	/* END */
...
class createElement_rating extends documentDOM_rating
{
	var $element	= '';
	...
	function createElement_rating($name, $attributes = array())
	{
		if ($name == '') return;
