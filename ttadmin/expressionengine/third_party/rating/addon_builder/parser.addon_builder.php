...
if (APP_VER < 2.0)
{
	eval('class Addon_builder_parser_base_rating extends Template { }');
}
else
{
	eval('class Addon_builder_parser_base_rating extends EE_Template { }');
}

class Addon_builder_parser_rating extends Addon_builder_parser_base_rating
{
	private $old_get = '';
