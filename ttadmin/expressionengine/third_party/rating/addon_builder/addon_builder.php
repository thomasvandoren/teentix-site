...
class Addon_builder_rating {
	...
	public function Addon_builder_rating ($name='')
	{
		//path to this folder
		...
		if (APP_VER < 2.0)
		{
			...
			if (($parent_class == 'Extension_builder_rating' OR 
				 $super_parent_class == 'Extension_builder_rating') AND 
		...
		//--------------------------------------------
		// documentDOM_rating instantiated, might move this.
		//--------------------------------------------

		if (REQ == 'CP' AND file_exists($this->aob_path . 'document_dom.php'))
		{
			if ( ! class_exists('documentDOM_rating'))
			{
				require_once $this->aob_path . 'document_dom.php';
			}
		
			$this->document = new documentDOM_rating();
		}
