...
class Low_variables_upd extends Low_variables_base {
	...
	function install()
	{
		...
		$this->EE->db->query(
			sprintf("CREATE TABLE IF NOT EXISTS `exp_low_variables` (
				...
				`variable_notes` text default '' NOT NULL,
				`variable_type` varchar(50) default '%s' NOT NULL,
				`variable_settings` text default '' NOT NULL,
	...
	function update($current = '')
	{
		...
		$this->EE->db->update('extensions', $ext_data, "class = '".$this->class_name."_ext'");
	...
	private function _v132()
	{
		...
		$this->EE->db->query("ALTER TABLE `exp_low_variables` ADD `group_id` INT(6) UNSIGNED default 0 NOT NULL AFTER `variable_id`");
		$this->_create_groups_table();
	...
	private function _v200()
	{
		...
		$this->EE->db->query("ALTER TABLE `exp_low_variables` ADD `edit_date` int(10) unsigned default 0 NOT NULL");
