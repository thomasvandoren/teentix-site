...
if (APP_VER < 2.0)
{
	eval('class Addon_builder_parser_base_code_pack extends Template { }');
}
else
{
	eval('class Addon_builder_parser_base_code_pack extends EE_Template { }');
}

class Addon_builder_parser_code_pack extends Addon_builder_parser_base_code_pack
{
	private $old_get = '';
