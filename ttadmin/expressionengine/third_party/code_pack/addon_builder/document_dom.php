...
class documentDOM_code_pack {
	...
	function documentDOM_code_pack()
	{
    ...
    {
    	$obj = new createElement_code_pack($name, $attributes);
    	return $obj;
	}
	/* END */
...
class createElement_code_pack extends documentDOM_code_pack
{
	var $element	= '';
	...
	function createElement_code_pack($name, $attributes = array())
	{
		if ($name == '') return;
