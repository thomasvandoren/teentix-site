...
class Addon_builder_tag {
	...
	public function Addon_builder_tag ($name='')
	{
		//path to this folder
		...
		if (APP_VER < 2.0)
		{
			...
			if (($parent_class == 'Extension_builder_tag' OR 
				 $super_parent_class == 'Extension_builder_tag') AND 
		...
		//--------------------------------------------
		// documentDOM_tag instantiated, might move this.
		//--------------------------------------------

		if (REQ == 'CP' AND file_exists($this->aob_path . 'document_dom.php'))
		{
			if ( ! class_exists('documentDOM_tag'))
			{
				require_once $this->aob_path . 'document_dom.php';
			}
		
			$this->document = new documentDOM_tag();
		}
