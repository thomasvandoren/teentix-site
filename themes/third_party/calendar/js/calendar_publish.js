jQuery(function($) {
	...
	var $move_to		= $cal_fields;

	// -------------------------------------
	//	version 2 needs differnt things
	// -------------------------------------

	if (SSCalendar.version > 1)
	{
	...
	var initialize = function() 
	{
		...
		if ($('#publishForm, .publishRows').length > 0) 
		{
	...
	var create_selector_widget = function($selectors) {
		$selectors.each(function() {
			...
			$(this).find('option').each(function() {
				...
				items.push($("<div class='item"+d_class+"'><a class='ui-corner-all " + s_class + "' href='#'>"+text+"</a></div>").data('value', $(this).val()).data('selector', selected));
				count ++;
			});
			if (items.length > 0) {
				items.push("<div class='item close'><a class='ui-corner-all' href='#'><span class='ui-icon  ui-icon-close'></span></a></div>");
			}
	...
	var _html_repeat_interval_daily = function() 
	{
		var output = {
			...
			extra: 	'<div class="group end line"><div class="leader">'				+ 
					'<label>End</label><select name="end"><option value="never">'	+
					SSCalendar.lang.never 	+ 	'</option><option value="by_date">'	+
					SSCalendar.lang.by_date +	'</option><option value="after">'	+
					SSCalendar.lang.after	+	'</option></select></div><br class="clear" /></div>'
		};
		return output;
	};
	...
	{
		var output = {
			options: '<div class="options"><label>Every</label><input type="text" name="every" value="1" /> '+SSCalendar.lang.week_s_on+':<div class="extended line dows"><select class="selector" multiple="multiple"><option value="U">'+SSCalendar.lang.day_0_3+'</option><option value="M">'+SSCalendar.lang.day_1_3+'</option><option value="T">'+SSCalendar.lang.day_2_3+'</option><option value="W">'+SSCalendar.lang.day_3_3+'</option><option value="R">'+SSCalendar.lang.day_4_3+'</option><option value="F">'+SSCalendar.lang.day_5_3+'</option><option value="S">'+SSCalendar.lang.day_6_3+'</option></select></div><br class="clear" /></div><br class="clear" />',
			extra: '<div class="group end line"><div class="leader"><label>'+SSCalendar.lang.end+'</label><select name="end"><option value="never">'+SSCalendar.lang.never+'</option><option value="by_date">'+SSCalendar.lang.by_date+'</option><option value="after">'+SSCalendar.lang.after+'</option></select></div><br class="clear" /></div>'
		};
		return output;
	};
	...
	{
		var output = {
			options: '<div class="options"><div class="every"><label>'+SSCalendar.lang.every+'</label><input type="text" name="every" value="1" /> <label>'+SSCalendar.lang.month_s_by_day_of+'</label> <select name="by"><option value="by_date">'+SSCalendar.lang.month+'</option><option value="by_relative">'+SSCalendar.lang.week+'</option></select></div><div class="extended by_relative"><select class="selector" multiple="multiple"><option value="1">'+SSCalendar.lang.x1st+'</option><option value="2">'+SSCalendar.lang.x2nd+'</option><option value="3">'+SSCalendar.lang.x3rd+'</option><option value="4">'+SSCalendar.lang.x4th+'</option><option value="5">'+SSCalendar.lang.x5th+'</option><option value="6">'+SSCalendar.lang.last+'</option></select><br class="clear" /></div><div class="extended by_date"><select class="selector" multiple="multiple"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="A">10</option><option value="B">11</option><option value="C">12</option><option value="D">13</option><option value="E">14</option><option value="F">15</option><option value="G">16</option><option value="H">17</option><option value="I">18</option><option value="J">19</option><option value="K">20</option><option value="L">21</option><option value="M">22</option><option value="N">23</option><option value="O">24</option><option value="P">25</option><option value="Q">26</option><option value="R">27</option><option value="S">28</option><option value="T">29</option><option value="U">30</option><option value="V">31</option></select><p class="clear">'+SSCalendar.lang.only_on+':</p></div><div class="extended line dows"><select class="selector" multiple="multiple"><option value="U">'+SSCalendar.lang.day_0_3+'</option><option value="M">'+SSCalendar.lang.day_1_3+'</option><option value="T">'+SSCalendar.lang.day_2_3+'</option><option value="W">'+SSCalendar.lang.day_3_3+'</option><option value="R">'+SSCalendar.lang.day_4_3+'</option><option value="F">'+SSCalendar.lang.day_5_3+'</option><option value="S">'+SSCalendar.lang.day_6_3+'</option></select><br class="clear" /></div></div><br class="clear" />',
			extra: '<div class="group end line"><div class="leader"><label>'+SSCalendar.lang.end+'</label><select name="end"><option value="never">'+SSCalendar.lang.never+'</option><option value="by_date">'+SSCalendar.lang.by_date+'</option><option value="after">'+SSCalendar.lang.after+'</option></select></div><br class="clear" /></div>'
		};
		return output;
	};
	...
	{
		var output = {
			options: '<div class="options"><label>'+SSCalendar.lang.every+'</label><input type="text" name="every" value="1" /> '+SSCalendar.lang.year_s+'.</div><br class="clear" />',
			extra: '<div class="group end line"><div class="leader"><label>'+SSCalendar.lang.end+'</label><select name="end"><option value="never">'+SSCalendar.lang.never+'</option><option value="by_date">'+SSCalendar.lang.by_date+'</option><option value="after">'+SSCalendar.lang.after+'</option></select></div><br class="clear" /></div>'
		};
		return output;
	};
	...
	{
		var output = '<div class="options"><input type="text" name="end_after" /> '+SSCalendar.lang.time_s+'</div>';
		return output;
	};
